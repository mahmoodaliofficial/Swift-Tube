...
export function HeroSection({ onFetch, isLoading }: HeroSectionProps) {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center px-4 pt-20 pb-16 md:pt-32 md:pb-24 overflow-visible">
      ...
      >
        <Youtube className="w-6 h-6 hover:text-[#ff0000] transition-colors cursor-pointer" title="YouTube" />
        <Instagram className="w-6 h-6 hover:text-[#d62976] transition-colors cursor-pointer" title="Instagram" />
        <TikTokIcon className="w-6 h-6 hover:text-[#fe0979] transition-colors cursor-pointer" title="TikTok" />
        <Twitter className="w-6 h-6 hover:text-[#1DA1F2] transition-colors cursor-pointer" title="Twitter" />
        <Facebook className="w-6 h-6 hover:text-[#1877F2] transition-colors cursor-pointer" title="Facebook" />
      </motion.div>
